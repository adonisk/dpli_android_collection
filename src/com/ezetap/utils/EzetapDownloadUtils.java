			...
			public void run() {
				try {
					...
					while ((ByteRead = is.read(buf)) != -1 && !bCancelled) {
						...
						if (appFileName == null || appFileName.equals(EzeConstants.KEY_SERVICE_APP_ID))
	...
	public Handler eventHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_START: {
				...
				dialog.setTitle(UIUtils.getResourceId("str_downloading", currentActivity));
				dialog.setMessage(UIUtils.getResourceString("str_downloading_app", currentActivity));

				dialog.setButton(UIUtils.getResourceString("str_cancel", currentActivity), 
