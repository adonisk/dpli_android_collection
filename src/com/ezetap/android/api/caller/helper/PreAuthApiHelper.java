...
public class PreAuthApiHelper extends ApiHelperBase implements ApiHelper {
	...
	public void callApi(JSONObject o, Activity callingActivity, int requestCode) {
		...
		try {
			...
			intent.putExtra(EzeConstants.KEY_ACTION, EzeConstants.ACTION_AUTHORISE_CARD);
			...
			if(o.has(EzeConstants.KEY_CUSTOMER_EMAIL) && o.getString(EzeConstants.KEY_CUSTOMER_EMAIL).length()>0 && !o.getString(EzeConstants.KEY_CUSTOMER_EMAIL).equalsIgnoreCase("null")){
