...
public class LoyaltyCheckBalanceApiHelper extends ApiHelperBase {
	...
	public void callApi(JSONObject o, Activity callingActivity, int requestCode) {
		...
		try {
			...
			intent.putExtra(EzeConstants.KEY_TRANSACTION_TYPE, EzeConstants.TXN_TYPE_BALANCE);
			intent.putExtra(EzeConstants.KEY_LOYALTY_TYPE, EzeConstants.TYPE_LOYALTY_NUMBER);
