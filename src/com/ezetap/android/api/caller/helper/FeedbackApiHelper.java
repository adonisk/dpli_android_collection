 ...
 *
 */
public class FeedbackApiHelper extends ApiHelperBase {
	...
	public void callApi(JSONObject o, Activity callingActivity, int requestCode) {
		Intent intent = new Intent(callingActivity, FeedbackHelperActivity.class);
		intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
		intent.putExtra(EzeConstants.KEY_ACTION, "feedback");
